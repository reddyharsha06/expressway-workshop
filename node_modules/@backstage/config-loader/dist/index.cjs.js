...
function compileConfigSchemas(schemas, options) {
  ...
  traverse__default["default"](
    ...
    (schema, jsonPtr, _1, _2, _3, parentSchema) => {
      var _a, _b;
      if (parentSchema == null ? void 0 : parentSchema.deepVisibility) {
        (_a = schema.deepVisibility) != null ? _a : schema.deepVisibility = parentSchema == null ? void 0 : parentSchema.deepVisibility;
      }
      if (schema == null ? void 0 : schema.deepVisibility) {
        (_b = schema.visibility) != null ? _b : schema.visibility = schema.deepVisibility;
        if (parentSchema) {
