    ...
    () => {
      ...
      const nodes = Object.entries(entities).map(([entityRef, entity]) => {
        ...
        const node = {
          ...
          spec: (_d = entity.spec) != null ? _d : void 0,
          focused,
...
const EntityCatalogGraphCard = catalogGraphPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-487df7ab.esm.js').then((m) => m.CatalogGraphCard)
    }
  })
);
const CatalogGraphPage = catalogGraphPlugin.provide(
  createRoutableExtension({
    ...
    component: () => import('./esm/index-ef2ac257.esm.js').then((m) => m.CatalogGraphPage),
